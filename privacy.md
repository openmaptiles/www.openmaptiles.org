...
We, the MapTiler team, formally represented by MapTiler AG, ID no:
CHE-345.466.193, with registered office at Zugerstrasse 22/Unterägeri, Zug
6314, Switzerland, maintain OpenMapTiles as an open-source project. If you
visit our website [openmaptiles.org](https://openmaptiles.org/) (the
...
We do not run any advertising, retargeting, or social-media pixels on this
Site.

## Cookies

A cookie banner asks for your consent before anything other than strictly
necessary cookies runs. Only two categories exist on this Site:
...
- **Necessary cookies** and basic security logging: legitimate interest
  (Art. 6(1)(f) GDPR).
- **Analytics cookies**, including the cross-domain measurement above: your
  consent (Art. 6(1)(a) GDPR), collected through the cookie banner. You can
...
Analytics data is kept for 14 months and then deleted automatically by
Google Analytics.
